...
public class MaioreMedia {
    public static void main(String[] args) {
        ...
        //variáveis
        int maior = 0; //guarda o maior número. Poderia ser double
        int soma = 0; //guarda a soma. Poderia ser double

        int count = 0; //controla o loop
        //loop
        do {
            System.out.println("Número: "); //Peça um número
            int numero = scan.nextInt(); //Entrada de dados, neste caso de um int. Poderia ser double
            ...
            soma = soma + numero; //some o número informado pelo usuário com variável soma
        ...
        System.out.println("Maior: " + maior + " - Média: " + (soma / 5));
    }
