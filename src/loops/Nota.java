...
public class Nota {
    public static void main(String[] args) {
        ...
        while(nota < 0 | nota > 10) { //Loop - Enquanto o valor da nota for menor que 0 ou maior que 10.
        ...
        System.out.println("Nota: " + nota); //imprime a nota válida, finaliza a estrutura de repetição automaticamente
